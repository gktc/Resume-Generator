...
const EducationPage = () => {
  ...
  const fetchEducation = async () => {
    try {
      setIsLoading(true);
      setError(null);
      const response = await api.get<{ success: boolean; data: { educations: Education[] } }>('/profile/education');
        ...
        <div className="mb-8">
          ...
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="mt-2 text-gray-600">Manage your academic background</p>
            </div>
            {!showForm && (
              <button
                onClick={handleAdd}
